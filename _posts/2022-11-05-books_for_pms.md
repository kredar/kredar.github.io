...
feature_row1:
  - image_path: /assets/images/neversplit.jpeg
    image_max_size: 10px
...
feature_row3: #DONE
  - image_path: /assets/images/lies.jpeg
    image_max_size: 10px
    alt: "Everybody Lies"
...
I recently found this great post with a visual guide on [Delibr](https://www.delibr.com/post/visual-guide-to-the-best-books-on-product-management). 
...
It’s a great resource with a useful step-by-step visualization of different Product Management functions and great book recommendations for each one of them. And although I agree with most of it, I would like to expand and add some books to the list. I might even update the visual at some point.

So here are some additional great book recommendations for Product Managers:

## Communication And Collaboration  
Communication is probably the most critical skill for PMs on any level. 
